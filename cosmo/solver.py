""" Parameter estimation methods for CoSMo """
import warnings
...
def fit_cosmo(timestamp, tensor, nc_comp, ns_comp, n_seasons,
    ...
    for iteration in range(max_iter):
        ...
        warnings.warn("CoSMo did not converge")
...
def cosmo_solver(timestamp, tensor, period, nc, ns,
