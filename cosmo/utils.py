...
def plot_grid_search_result(cosmo_obj, scores, filename=None, title=None):

    c_set = np.arange(cosmo_obj.maxc - cosmo_obj.minc + 1)
    s_set = np.arange(cosmo_obj.maxs - cosmo_obj.mins + 1)
